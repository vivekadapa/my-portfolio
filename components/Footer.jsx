    ...
    return (
        <div className="pb-12">
            <ul className="flex flex-wrap w-full justify-center gap-8 font-semibold">
                ...
                <li><a href="https://www.linkedin.com/in/vivekadapa" className="text-gray-500 hover:text-gray-600 transition" target="_blank" rel="noopener noreferrer">Linkedin</a></li>
